    ...
    <>
      <main className=" relative flex justify-between mt-10 items-center bg-[#FFE0D0]">
        ...
        <section className="flex mx-[16rem] mr-36 flex-col text-[#333D42] gap-12 py-24 justify-center">
          ...
          <p className="text-3xl w-[54rem] font-light">
            ...
            هنا من اجل صحة نفسية افضل.
          </p>
          <Button className="w-[20rem] py-12 text-2xl bg-[#FCD961]">
            اعرف اكتر عن منصة سلامي
          </Button>
        </section>
      </main>
      <div className="flex flex-col items-center gap-10 pt-36 justify-center bg-white">
        <h2 className="text-3xl justify-center font-light text-[#F05B5B]">
          مهمتنا
        </h2>
        <h2 className="text-5xl text-center w-[62rem] leading-relaxed font-semibold">
          نساعدك بالمعرفة والخبرة لتعزيز صحتك النفسية والوصول إلى السلام النفسي
        </h2>
      </div>
      ...
      <div className="flex flex-col items-center gap-10 py-36 bg-[#F05B5B] justify-center">
        ...
        <p className="text-3xl font-light text-white">
          انضم إلى قائمتنا البريدية وكن على إطلاع على احدث المقالات وأهم النصائح
          اليومية في الصحة النفسية.
        </p>
        <div className="relative w-[44rem] my-10" id="newsletter">
          <Input
            classNames={{
              ...
              inputWrapper: ["bg-[#FFEEDD] p-10", "!cursor-text"],
            }}
            size="lg"
            radius="md"
          ...
          />
          <Button
            className=" absolute top-0 left-0 p-10 w-44 bg-[#fcd961] text-[#656667]"
            radius="sm"
          >
            اشترك
          </Button>
